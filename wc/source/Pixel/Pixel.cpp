...
void Pixel::SetScreenPosX(float newScreenPosX) noexcept
{
    ScreenPosX = newScreenPosX;
}

void Pixel::SetScreenPosY(float newScreenPosY) noexcept
{
...
void Pixel::ScreenPosYCalc(const ACamera& playerCamera)
{
    ...
    // итоговый угол делим на 2, так как в консоли высота символа в два раза больше ширины
    // “о есть по ширине € выбрал, что один угол равен ширине одного символа. Ќо высота этого символа равна две его ширины.
