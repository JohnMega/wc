...
void RayCastingFromCamera(const std::vector<AActor*>& actors, const ACamera& playerCamera, COORDS rightUpCamCoord, COORDS cameraVecUpOrDown, COORDS cameraVecLeftOrRight, int yStart, int yEnd);
