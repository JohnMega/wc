...
float& Pyramid::GetLenght() noexcept
{
    return lowerBaselength;
}

float& Pyramid::GetWidth() noexcept
{
    return lowerBasewidth;
}

float& Pyramid::GetHeight() noexcept
{
    return height;
}
...
Range& Pyramid::SetRange() noexcept
{
    return basePyrRange;
}
