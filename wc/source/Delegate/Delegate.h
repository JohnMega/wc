...
private:
	...
	static void RunObsFuncWithArgs(AActor* Observer, void(AActor::* Func)(Args...), const Args&... args);

public:
	void Broadcast();

	template <typename Type>
	void AddUObject(AActor* Observer, void(Type::* Func)(Args...), const Args&... args);
};

template <typename... Args>
void Delegate<Args...>::RunObsFuncWithArgs(AActor* Observer, void(AActor::* Func)(Args...), const Args&... args)
{
	(Observer->*Func)(args...);
}
...
template <typename... Args>
template <typename Type>
void Delegate<Args...>::AddUObject(AActor* Observer, void(Type::* Func)(Args...), const Args&... args)
{
	Observers.push_back(Observer);
	ObserversFunctions.push_back(reinterpret_cast<void(AActor::*)(Args...)>(Func));

	if constexpr (sizeof...(Args) != 0)
		ObserversFunctionsArgs.push_back(args...);
}